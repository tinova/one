...
install_patch() {
    ...
    (cd bower_components/no-vnc/ && pwd >> /tmp/debug.log && ls -la >> /tmp/debug.log && npm install && ./utils/use_require.js --clean --as amd && sed -i -e "s/'\.\//'\.\.\/bower_components\/no-vnc\/lib\//g" lib/rfb.js )
